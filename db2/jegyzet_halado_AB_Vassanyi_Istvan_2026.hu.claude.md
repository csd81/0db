...
declare @orderid int
select @orderid=orderid from inserted  --FIGYELEM: ha több rekord szerepel az inserted táblában, csak az utolsó értékét kapjuk meg — ez hibás működéshez vezethet
...
Egy Firestore-tranzakció olvasási műveleteket tartalmazhat, amelyeket írási műveletek követnek. *Ha egy tranzakció olvas egy dokumentumot, majd a dokumentumot egy másik kliens módosítja a commit előtt, a tranzakció automatikusan visszagörgetésre kerül és újrafuttatódik (legfeljebb 5-ször).* Az atomicitás egyetlen commit művelet szintjén garantált, de párhuzamos módosítások esetén a tranzakció újrafuttatása szükséges lehet. Példa:
