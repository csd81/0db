...
- **Tutte 1963** — az első polinomiális idejű algoritmus.
- **Hopcroft–Tarjan 1974** — lineáris idejű $O(|V|+|E|)$ algoritmus, ami nem csak eldönt, hanem konkrét síkbarajzolást is konstruál.

Történeti jegyzet: Kuratowski 1930-as eredményével **nagyjából egy időben** Frink és Smith amerikai matematikusok is hasonló jellemzést bizonyítottak, de a dolgozatuk soha nem jelent meg publikálva — így a tétel Kuratowski nevéhez fűződik.
