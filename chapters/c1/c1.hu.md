...
- Megjegyzés: a **tárolt eljárás** több rekordhalmazt is visszaadhat, ha változóhozzárendelés nélkül több `SELECT` utasítást tartalmaz. Az érték szerint átadott paraméterek (mint a fenti példában) INPUT típusúak. A tárolt eljárások OUTPUT paraméterekkel skaláris értékeket is visszaadhatnak (a példában nem szerepel). Mivel más tárolt eljárásokat és függvényeket is meghívhatnak, összetett üzleti logika is megvalósítható velük az adatbázis-szerveren.
...
**PÉLDA** egy tranzakciót használó egyszerű tárolteljárás-vázra:
